        ...
        try {
            ...
            while (result.next()) {
                ...
                if (canEditPersonInfo(personByNumber, idEmissionDate)) {
                    ...
                    String nameOfFather = nameOfFatherString == null ? null : StringFormatter.prettyPrint(nameOfFatherString);
                    String nameOfMotherString = result.getString("mother");
                    String nameOfMother = nameOfMotherString == null ? null : StringFormatter.prettyPrint(nameOfMotherString);
